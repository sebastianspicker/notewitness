...
def _resource_limited_launcher_command(
    ...
    """Build the launcher command through the established facade patch seam."""

    return _policy_resource_limited_launcher_command(
        command,
        timeout_seconds,
        launcher_factory=_trusted_python_launcher,
    )
